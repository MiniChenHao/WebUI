<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PageControl.ascx.cs"
    Inherits="AdminUI.UserControl.PageControl" %>
...
<div class="pagination">
    ...
    <div style="float: right;">
        <table border="0" cellspacing="0" cellpadding="0">
            <tbody>
                <tr>
                    <td><div class="pagination-btn-separator" /></td>
                    <td>
                        &nbsp;<asp:LinkButton ID="hlkFirst" title="首 页" runat="server" OnClick="hlkFirst_Click"><span id="spfirst" class="first"></span>首 页</asp:LinkButton>
                    </td>
                    <td>
                        &nbsp;<asp:LinkButton ID="hlkPrev" title="上 页" runat="server" OnClick="hlkPrev_Click"><span id="spprev" class="prev"></span>上 页</asp:LinkButton>
                    </td>
                    <td><div class="pagination-btn-separator" /></td>
                    <td>
                        &nbsp; 第
                    ...
                    <td><div class="pagination-btn-separator" /></td>
                    <td>
                        &nbsp;<asp:LinkButton ID="hlkNext" title="下 页" runat="server" OnClick="hlkNext_Click"><span id="spnext" class="next" ></span>下 页</asp:LinkButton>
                    </td>
                    <td>
                        &nbsp;<asp:LinkButton ID="hlkLast" title="尾 页" runat="server" OnClick="hlkLast_Click"><span id="splast" class="last" ></span>尾 页</asp:LinkButton>
                    </td>
                    <td><div class="pagination-btn-separator" /></td>
                    <td>
                        <asp:DropDownList ID="ddlpageList" CssClass="select" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlpageList_SelectedIndexChanged">
